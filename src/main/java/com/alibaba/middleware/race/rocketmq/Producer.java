...
public class Producer {
    ...
    public static void main(String[] args) throws MQClientException, InterruptedException {
        ...
        producer.setNamesrvAddr("10.150.0.94:9876");
        ...
        for (int i = 0; i < count; i++) {
            try { 
                ...
                if (i%50000==0) {
                	 long createTime=(orderMessage.getCreateTime()/1000/60)*60;
                ...
                producer.send(msgToBroker, new SendCallback() {
                    ...
                    //    logger.error(" "+platform+"--"+orderMessage.getOrderId());
                        semaphore.release();
                ...
                for (final PaymentMessage paymentMessage : paymentMessages) {
                    ...
                    if (retVal > 0) {
                        ...
                        producer.send(messageToBroker, new SendCallback() {
                           ...
                           // 	logger.error(paymentMessage.toString());
                            //    System.out.println(paymentMessage);
                             //   System.out.println("当前已经有a"+semaphore.availablePermits());
                            }
                            public void onException(Throwable throwable) {
                                throwable.printStackTrace();
                            }
